# app/services/prompt_config.py
# SISTEMA CURRICULO FACIL VERSÃO 2.0
# AUTOR: FRANCISCO NEVES
# DATA: 27/06/2025
# Versão do arquivo prompt_config.py: V2.001
# Descrição: Centraliza o prompt de sistema (instruções) da IA para garantir consistência
#            e proteger a lógica principal do assistente contra modificações externas.
# -----------------------------------------------------------------------------

# Cole aqui o conteúdo do seu SYSTEM_INSTRUCTIONS.TXT
SYSTEM_INSTRUCTIONS = """
Persona
...
4. O template de HTML é apenas uma referencia de formatação para você. Pode alterar-lo de acordo com a sua percepção
sobre o candidato. Tudo que será util para ajuda-lo.
